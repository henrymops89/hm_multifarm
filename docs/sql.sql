-- ================================================
-- MULTI-FARM v0.3.0 - DATABASE SCHEMA
-- Kühe, Hühner, Schweine
-- ================================================

-- Create slots table (für ALLE Tierarten!)
...
-- Create owned animals table (für ALLE Tierarten!)
...
-- KUH-SLOTS (1-10) - Deine Original-Koordinaten
...
-- HÜHNER-SLOTS (1-10) - Bereich um Hühner-NPC
INSERT INTO `multifarm_slots` (`slot_number`, `animal_type`, `pos_x`, `pos_y`, `pos_z`, `heading`) VALUES
...
-- SCHWEINE-SLOTS (1-10) - Bereich um Schweine-NPC
INSERT INTO `multifarm_slots` (`slot_number`, `animal_type`, `pos_x`, `pos_y`, `pos_z`, `heading`) VALUES
...
-- ================================================
-- MIGRATION: Old table to new (Optional)
-- Wenn du alte holycow_owned Daten hast
-- ================================================

-- INSERT INTO multifarm_owned (owner, animal_type, breed_id, slot_id, custom_name, purchased_at, last_collected, total_produced)
-- SELECT owner, 'cow', cow_type, slot_id, custom_name, purchased_at, last_milked, total_milk_produced
-- FROM holycow_owned;

-- ================================================
-- DONE!
-- ================================================
-- Your database is now ready for Multi-Farm v0.3.0
-- 
-- 30 Slots total:
-- - 10 Kühe
-- - 10 Hühner
